...
export default function AboutMe(props) {
  ...
  const SCREEN_CONSTATNTS = {
    description:
      "Hello, My call name is Sai. I'm a Computer Science graduate and dedicated programmer with strong foundation programming skills, nerd in Java who enjoys challenging tasks and has keen eye for innovations and developments.",
    highlights: {
